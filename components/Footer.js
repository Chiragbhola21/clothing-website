    ...
    <footer className={styles.footer}>
      <div className={styles.container}>
        ...
        <div className={styles.newsletter}>
          ...
          <p className={styles.nlText}>Subscribe for exclusive drops, offers and style updates.</p>
        ...
        <div className={styles.linksGrid}>
          ...
          <div className={styles.linkCol}>
            <h4 className={styles.colTitle}>MORE INFO</h4>
        ...
        <div className={styles.bottom}>
          <div className={styles.payments}>
            <span className={styles.payLabel}>100% Secure Payment</span>
          ...
          <p className={styles.copyright}>&copy; 2026 SOULED. All rights reserved. Made in India.</p>
        </div>
      </div>
    </footer>
  );
